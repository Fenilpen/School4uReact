...
{/* Mobile view */}
      <div className={`absolute bg-[black] h-screen top-0 left-0 w-[20rem] flex flex-col translate-x-[100%] ${mobileview ? 'translate-x-0' : "translate-x-[100%]"}`} transition-all duration-150>
        <button 
        onClick={()=>{
